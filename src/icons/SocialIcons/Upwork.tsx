export const Upwork = () => {
    return (
        <svg fill="currentColor" stroke="currentColor" className="size-10 hover:text-green-500 transition-all duration-500 hover:-translate-y-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 641 512">
