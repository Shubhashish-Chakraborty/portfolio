    ...
    return (
        <>  
            <div className="flex justify-center flex-wrap bg-blue-50">
                ...
                <ProjectBox title="Private Data Manager" thumbnail="https://myprivdata.vercel.app/myPrivData_Logo.png" githubLink="https://github.com/Shubhashish-Chakraborty/myprivdata"  webLink="https://myprivdata.vercel.app" description="some description i will add later"/>
